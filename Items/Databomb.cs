...
{
    public class Databomb : ModItem
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Databomb");
			Tooltip.SetDefault("Kaboom");
		}
        public override void SetDefaults()
        {
            item.damage = 139;     //The damage stat for the Weapon.                    
            ...
            item.shoot = mod.ProjectileType("DatabombProj"); //This defines what type of projectile this item will shoot	
        ...
        public override void AddRecipes()   //This defines the crafting recepe for this item
        {
            ...
            recipe.AddIngredient(ItemID.Bomb, 5); //this is how to add an ingredient from Terraria,  so for crafting this item you need 15 bombs      		
            recipe.AddIngredient(mod.ItemType("DataCells"), 1); //this is an example of how to add a modded item as an ingredient
            ...
            recipe.SetResult(this, 1);   //this defines the resultat of hte crafting, so 15 bombs + 1 customtileitem = 15 Custom Explosive
            recipe.AddRecipe();
        }
    }
}
